...
import { wagmiConfig, reconnectRecentWallet } from "./lib/wagmi";
  ...
  <WagmiProvider config={wagmiConfig} reconnectOnMount={false}>
    <trpc.Provider client={trpcClient} queryClient={queryClient}>
      <QueryClientProvider client={queryClient}>
        <RainbowKitProvider
          theme={lightTheme({ accentColor: "#102A43", accentColorForeground: "#fff", borderRadius: "medium", fontStack: "system" })}
          initialChain={102031}
          appInfo={{ appName: "SignalProof", learnMoreUrl: "https://signalproof.mdloglabs.org/docs" }}
        >
          <App />
        </RainbowKitProvider>
      </QueryClientProvider>
