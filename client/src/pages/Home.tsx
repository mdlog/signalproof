...
type ProofLookup = RouterOutputs["signalproof"]["proofFor"];
type ProofQuery = { isLoading: boolean; data: ProofLookup | undefined };
 ...
 */
function ProofPanel({ query, settled }: { query: ProofQuery; settled: boolean }) {
